...
const Contact = () => {
  return (
    <div name="contact" className='w-full h-screen bg-[#0a192f] flex flex-col justify-center items-center p-4'>
           <p className='text-4xl font-bold inline border-b-4 border-pink-600 text-gray-300 font-serif'>Contact</p>
    <form method='POST' action="https://getform.io/f/637e44b5-c6d0-4b40-a735-422257c272f7" className='flex flex-col max-w-[600px] w-full'>
        <div className='pb-8 '>
            <p className='text-gray-300 py-4 text-center'>Submit the form below. <br /> Or send email to john.coh98@gmail.com <br />Or contact me from this number 054-369-2295</p>
        </div>
